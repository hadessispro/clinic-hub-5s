...
@Module({
  controllers: [HealthController, AuthController, PgRegistrationController, DataController, AttendanceController, AttendanceWorkController, AttendanceAdjustmentController, RpcController, FilesController, PushController, MarketingController, GiftsController, ScheduleController],
